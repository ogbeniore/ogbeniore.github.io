  ...
  <Layout>
    <div class="projects">
      <div class="projects__content">
        <h1 class="projects__content__header">Proj<span class="text-main">ects</span></h1>
      </div>
    </div>
    <Navigation half="true" />
  </Layout>
</template>
...
.projects {
  background: linear-gradient(90deg, $main-color 50%, $accent-color 50%);
  min-height: 100vh;
  position: relative;
  display: flex;
  ...
  @media screen and (max-width: 600px) {
    background: linear-gradient(180deg, $main-color 50%, $accent-color 50%);
  }
  &:before,
  &:after {
    position: absolute;
